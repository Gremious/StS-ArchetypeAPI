...
public class ExhaustIroncladArchetypeSelectCard extends AbstractArchetypeCard {
    ...
    public static final String ID = "archetypeAPI:ExhaustIroncladArchetypeSelectCard";

    public static final String IMG = "archetypeAPIResources/images/cards/corruption.png";
    ...
    public void archetypeEffect() {
        ExhaustIronclad ExhaustIronclad = new ExhaustIronclad();
    }
